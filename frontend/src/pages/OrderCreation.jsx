      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="md:flex">
          <div className="p-8 w-full">
            <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold mb-1">Place Order</div>
            {
               !orderCreated && <form onSubmit={handleSubmit} className="space-y-6">
               <div>
            ...
            {
              orderCreated && <OrderPayment orderDetails={order} />
            }
          </div>
        </div>
      </div>
